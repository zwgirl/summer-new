...
import org.summer.jdi.internal.AccessibleImpl;
...
import org.summer.sdt.debug.eval.ICompiledExpression;
...
import org.summer.sdt.internal.debug.core.model.JDIStackFrame;
...
public class JavaLineBreakpoint extends JavaBreakpoint implements
	 ...
	 * <code>"org.summer.sdt.debug.core.condition"</code>). This attribute is
	 * stored as a <code>String</code>.
	 */
	protected static final String CONDITION = "org.summer.sdt.debug.core.condition"; //$NON-NLS-1$
	/**
	 * Breakpoint attribute storing a breakpoint's condition enabled state
	 * (value <code>"org.summer.sdt.debug.core.conditionEnabled"</code>). This
	 * attribute is stored as an <code>boolean</code>.
	 */
	protected static final String CONDITION_ENABLED = "org.summer.sdt.debug.core.conditionEnabled"; //$NON-NLS-1$

	/**
	 * Breakpoint attribute storing a breakpoint's condition suspend policy
	 * (value <code>" org.summer.sdt.debug.core.conditionSuspendOnTrue"
	 * </code>). This attribute is stored as an <code>boolean</code>.
	 */
	protected static final String CONDITION_SUSPEND_ON_TRUE = "org.summer.sdt.debug.core.conditionSuspendOnTrue"; //$NON-NLS-1$

	/**
	 * Breakpoint attribute storing a breakpoint's source file name (debug
	 * attribute) (value <code>"org.summer.sdt.debug.core.sourceName"</code>).
	 * This attribute is stored as a <code>String</code>.
	 */
	protected static final String SOURCE_NAME = "org.summer.sdt.debug.core.sourceName"; //$NON-NLS-1$

	public static final String JAVA_LINE_BREAKPOINT = "org.summer.sdt.debug.javaLineBreakpointMarker"; //$NON-NLS-1$
	 ...
	 * 
	 * @see
	 * org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#addToTarget
	 ...
	 * 
	 * @see
	 * org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#newRequest
	 * (org.summer.sdt.internal.debug.core.model.JDIDebugTarget,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaLineBreakpoint#supportsCondition()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaLineBreakpoint#getCondition()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaLineBreakpoint#setCondition(java.lang
	 * .String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaLineBreakpoint#isConditionEnabled()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaLineBreakpoint#setConditionEnabled(boolean
	 * )
	 */
	 ...
	 * (org.summer.sdt.internal.debug.core.model.JDIThread)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaLineBreakpoint#isConditionSuspendOnTrue()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaLineBreakpoint#setConditionSuspendOnTrue
	 * (boolean)
	 */
