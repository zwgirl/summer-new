...
import org.summer.sdt.launching.sourcelookup.DirectorySourceLocation;
import org.summer.sdt.launching.sourcelookup.IJavaSourceLocation;
import org.summer.sdt.launching.sourcelookup.JavaProjectSourceLocation;
	...
	class SourceLocationPropertiesAdapter implements IWorkbenchAdapter {
		...
		public ImageDescriptor getImageDescriptor(Object o) {
			if (o instanceof JavaProjectSourceLocation) {
				...
				return JavaUI.getSharedImages().getImageDescriptor(org.summer.sdt.ui.ISharedImages.IMG_OBJS_JAR);
			}
			return null;
		}
