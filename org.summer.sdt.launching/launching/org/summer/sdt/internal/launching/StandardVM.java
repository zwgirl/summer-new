...
import org.summer.sdt.launching.IVMRunner;
...
public class StandardVM extends AbstractVMInstall {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.launching.IVMInstall#getVMRunner(java.lang.String)
	 */
	@Override
    ...
    /* (non-Javadoc)
     * @see org.summer.sdt.launching.IVMInstall#getJavaVersion()
     */
    @Override
