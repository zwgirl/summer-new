...
import org.summer.sdt.debug.core.IEvaluationRunnable;
...
import org.summer.sdt.internal.debug.core.breakpoints.ConditionalBreakpointHandler;
...
public class JDIThread extends JDIDebugElement implements IJavaThread {
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaThread#runEvaluation(org.summer.sdt.
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaThread#queueRunnable(java.lang.Runnable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#terminateEvaluation()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#canTerminateEvaluation()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#isSystemThread()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#isDaemon()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#getThreadGroupName()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#isOutOfSynch()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#mayBeOutOfSynch()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaThread#findVariable(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#isPerformingEvaluation()
	 */
	...
	class StepOverHandler extends StepHandler {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.summer.sdt.internal.debug.core.model.JDIThread.StepHandler#
		 * getStepKind()
		 */
		@Override
	...
	class DropToFrameHandler extends StepReturnHandler {
		...
		protected void invokeThread() throws DebugException {
			if (getFramesToDrop() < 0) {
				...
				try {
					org.summer.jdi.hcr.ThreadReference hcrThread = (org.summer.jdi.hcr.ThreadReference) fThread;
		...
		protected StepRequest createStepRequest() throws DebugException {
			...
			if (num > 0) {
				...
				try {
					StepRequest request = ((org.summer.jdi.hcr.EventRequestManager) manager).createReenterStepRequest(fThread);
					request.setSuspendPolicy(EventRequest.SUSPEND_EVENT_THREAD);
					request.addCountFilter(1);
					request.enable();
					return request;
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaThread#hasOwnedMonitors()
	 */
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaThread#getOwnedMonitors()
	 */
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaThread#getContendedMonitor()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaThread#stop(org.summer.sdt.debug.core
	 * .IJavaObject)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#getThreadGroup()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#getFrameCount()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.debug.core.IJavaThread#getThreadObject()
	 */
