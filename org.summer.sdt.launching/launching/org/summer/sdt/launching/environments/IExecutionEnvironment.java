 ...
 *******************************************************************************/
package org.summer.sdt.launching.environments;
...
/**
 * An execution environment describes capabilities of a Java runtime environment (<code>IVMInstall</code>).
 * <p>
 * An execution environment is contributed in plug-in XML via the <code>org.summer.sdt.launching.executionEnvironments</code> extension point.
 * </p>
 * <p>
...
public interface IExecutionEnvironment {
	...
	/**
	 * Returns a collection of access rules to be applied to the specified VM libraries for this execution environment in the context of the given
	 * project. An array of access rules is returned for each library specified by <code>libraries</code>, possibly empty.
	 * <p>
	 * Access rules for an execution environment are defined by access rule participants contributed in a
	 * <code>org.summer.sdt.launching.executionEnvironments</code> extension.
	 * </p>
	 * 
	 * @param vm
