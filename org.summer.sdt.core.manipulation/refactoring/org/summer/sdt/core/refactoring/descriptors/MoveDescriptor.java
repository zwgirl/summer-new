 ...
 *******************************************************************************/
package org.summer.sdt.core.refactoring.descriptors;

import java.util.Map;

import org.summer.sdt.core.refactoring.IJavaRefactorings;
import org.summer.sdt.internal.core.refactoring.descriptors.DescriptorMessages;
import org.summer.sdt.internal.core.refactoring.descriptors.JavaRefactoringDescriptorUtil;
...
public final class MoveDescriptor extends JavaRefactoringDescriptor {
	...
	private static final String POLICY_MOVE_MEMBERS= "org.summer.sdt.ui.moveMembers"; //$NON-NLS-1$

	/** The move packages policy */
	private static final String POLICY_MOVE_PACKAGES= "org.summer.sdt.ui.movePackages"; //$NON-NLS-1$

	/** The move resources policy */
	private static final String POLICY_MOVE_RESOURCES= "org.summer.sdt.ui.moveResources"; //$NON-NLS-1$

	/** The move package fragment roots policy */
	private static final String POLICY_MOVE_ROOTS= "org.summer.sdt.ui.moveRoots"; //$NON-NLS-1$
