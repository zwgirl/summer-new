...
public class EEVMInstall extends StandardVM {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.launching.StandardVM#getJavaVersion()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.launching.StandardVM#getJavaExecutable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.launching.StandardVM#getDebugArgs()
	 */
	@Override
