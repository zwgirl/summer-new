 ...
 * to the <code>"org.summer.sdt.launching.vmInstallTypes"</code> extension point.
 * Rather than implementing this interface directly, it is strongly recommended that
 * clients subclass {@link org.summer.sdt.launching.AbstractVMInstall} to be insulated
 * from potential API additions. In 3.1, a new optional interface has been added for
 * implementors of this interface - {@link org.summer.sdt.launching.IVMInstall2}.
 * The new interface is implemented by {@link org.summer.sdt.launching.AbstractVMInstall}.
 * </p>
 * @see org.summer.sdt.launching.IVMInstall2
 */
