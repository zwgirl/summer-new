 ...
 *******************************************************************************/
package org.summer.sdt.debug.ui;
...
import org.summer.sdt.internal.debug.ui.DebugUIMessages;
...
import org.summer.sdt.internal.debug.ui.launcher.SourceElementLabelProvider;
import org.summer.sdt.internal.debug.ui.launcher.SourceElementQualifierProvider;
import org.summer.sdt.launching.JavaRuntime;
import org.summer.sdt.launching.sourcelookup.IJavaSourceLocation;
import org.summer.sdt.launching.sourcelookup.JavaSourceLocator;
 ...
 *             <code>org.eclipse.debug.core.sourcelookup.containers</code>. This class has been replaced by a Java source lookup director and Java
 *             source lookup participant. To migrate to the new source lookup support clients should add two new attributes to their launch
 *             configuration type extensions:
 *             <ul>
 *             <li>sourceLocatorId="org.summer.sdt.launching.sourceLocator.JavaSourceLookupDirector"</li>
 *             <li>sourcePathComputerId="org.summer.sdt.launching.sourceLookup.javaSourcePathComputer"</li>
 *             </ul>
 *             The source locator id attribute specifies to use the Java source lookup director for launch configurations of the associated type, and
 *             the source path computer id attribute specifies the class to use when computing a default source lookup path for a launch
 *             configuration. The path computer referenced/provided (by the above id), computes a default source lookup path based on the support
 *             provided in the 2.0 release - i.e. a configuration's <code>ATTR_SOURCE_PATH_PROVIDER</code> attribute (if present), or a default source
 *             lookup path based on a configuration's runtime classpath. This class has been replaced by the Java source lookup director which is an
 *             internal class, but can be used via the <code>sourceLocatorId</code> attribute on a launch configuration type extension.
...
public class JavaUISourceLocator implements IPersistableSourceLocator {
	...
	/**
	 * Identifier for the 'Prompting Java Source Locator' extension (value <code>"org.summer.sdt.debug.ui.javaSourceLocator"</code>).
	 */
