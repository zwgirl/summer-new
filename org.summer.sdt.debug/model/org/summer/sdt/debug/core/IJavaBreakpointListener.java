...
/**
 * Provides event and error notification for Java breakpoints. Listeners register with the <code>JDIDebugModel</code>.
 * <p>
 * Since 3.5, clients can also register breakpoint listeners using the <code>org.summer.sdt.debug.breakpointListeners</code> extension point. A
 * listener can be contributed to receive notifications from all Java breakpoints or receive notifications about specific breakpoints by
