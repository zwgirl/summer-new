...
public abstract class AbstractRuntimeClasspathEntry extends PlatformObject implements IRuntimeClasspathEntry2 {
	 ...
	 * (non-Javadoc)
	 * 
	 * Default implementation returns <code>false</code>. Subclasses should override if required.
	 * 
	 * @see org.summer.sdt.internal.launching.IRuntimeClasspathEntry2#isComposite()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * Default implementation generates a string containing an XML document. Subclasses should override <code>buildMemento</code> to specify the
	 ...
	 * (non-Javadoc)
	 * 
	 * Default implementation returns <code>null</code>. Subclasses should override if required.
	 * 
