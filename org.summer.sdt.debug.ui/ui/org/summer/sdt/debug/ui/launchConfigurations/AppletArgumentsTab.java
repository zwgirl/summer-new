...
import org.summer.sdt.internal.debug.ui.launcher.AppletWorkingDirectoryBlock;
...
public class AppletArgumentsTab extends JavaArgumentsTab {
	...
	/**
	 * @see org.summer.sdt.debug.ui.launchConfigurations.JavaArgumentsTab#createWorkingDirBlock()
	 */
	@Override
	...
	/**
	 * @see org.summer.sdt.debug.ui.launchConfigurations.JavaArgumentsTab#setHelpContextId()
	 */
	@Override
