...
import org.summer.sdt.internal.debug.core.model.JDIValue;
...
public class JavaExceptionBreakpoint extends JavaBreakpoint implements
	...
	public static final String JAVA_EXCEPTION_BREAKPOINT = "org.summer.sdt.debug.javaExceptionBreakpointMarker"; //$NON-NLS-1$

	/**
	 * Exception breakpoint attribute storing the suspend on caught value (value
	 * <code>"org.summer.sdt.debug.core.caught"</code>). This attribute is
	 ...
	 */
	protected static final String CAUGHT = "org.summer.sdt.debug.core.caught"; //$NON-NLS-1$
	/**
	 * Exception breakpoint attribute storing the suspend on uncaught value
	 * (value <code>"org.summer.sdt.debug.core.uncaught"</code>). This
	 ...
	 */
	protected static final String UNCAUGHT = "org.summer.sdt.debug.core.uncaught"; //$NON-NLS-1$	
	/**
	 * Exception breakpoint attribute storing the checked value (value
	 * <code>"org.summer.sdt.debug.core.checked"</code>). This attribute is
	 * stored as a <code>boolean</code>, indicating whether an exception is a
	 * checked exception.
	 */
	protected static final String CHECKED = "org.summer.sdt.debug.core.checked"; //$NON-NLS-1$	

	/**
	 * Exception breakpoint attribute storing the String value (value
	 * <code>"org.summer.sdt.debug.core.filters"</code>). This attribute is
	 ...
	 * INCLUSIVE_FILTERS.
	 */
	protected static final String INCLUSION_FILTERS = "org.summer.sdt.debug.core.inclusion_filters"; //$NON-NLS-1$	
	 ...
	 * INCLUSIVE_FILTERS.
	 */
	protected static final String EXCLUSION_FILTERS = "org.summer.sdt.debug.core.exclusion_filters"; //$NON-NLS-1$	
	/**
	 ...
	 * @since 3.2
	 */
	protected static final String SUSPEND_ON_SUBCLASSES = "org.summer.sdt.debug.core.suspend_on_subclasses"; //$NON-NLS-1$
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaExceptionBreakpoint#setSuspendOnSubclasses
	 * (boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaExceptionBreakpoint#isSuspendOnSubclasses
	 * ()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#setInstalledIn
	 * (org.summer.sdt.debug.core.IJavaDebugTarget, boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaExceptionBreakpoint#getExceptionTypeName
	 * ()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaExceptionBreakpoint#getExclusionFilters()
	 */
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaExceptionBreakpoint#getInclusionFilters()
	 */
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaExceptionBreakpoint#setExclusionFilters(String[])
	 */
	...
	/**
	 * @see org.summer.sdt.debug.core.IJavaExceptionBreakpoint#setInclusionFilters(String[])
	 */
	...
	/**
	 * @see org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#addInstanceFilter(EventRequest,
	 *      ObjectReference)
	 */
	@Override
