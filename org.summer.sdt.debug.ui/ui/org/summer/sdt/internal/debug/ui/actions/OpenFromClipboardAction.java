...
import org.summer.sdt.internal.debug.ui.console.JavaStackTraceConsole;
import org.summer.sdt.internal.debug.ui.console.JavaStackTraceConsoleFactory;
...
public class OpenFromClipboardAction implements IWorkbenchWindowActionDelegate {
	...
	/**
	 * Pattern to match a qualified name e.g. <code>org.summer.sdt.internal.debug.ui.actions.OpenFromClipboardAction</code>, or match a simple name
	 * e.g. <code>OpenFromClipboardAction</code>.
	 */
	private static final String QUALIFIED_NAME_PATTERN = "(" + SIMPLE_NAME_PATTERN //$NON-NLS-1$
			+ "\\.)*" + SIMPLE_NAME_PATTERN; //$NON-NLS-1$

	/**
	 * Pattern to match a qualified name e.g. <code>org.summer.sdt.internal.debug.ui.actions.OpenFromClipboardAction</code>.
	 */
	 ...
	 * <code>org.summer.sdt.internal.debug.ui.actions.OpenFromClipboardAction : 21</code>
	 */
	...
	/**
	 * Pattern to match a method e.g. <code>org.summer.sdt.internal.debug.ui.actions.OpenFromClipboardAction.run(IAction)</code> ,
