...
public class JavaPatternBreakpoint extends JavaLineBreakpoint implements
	...
	private static final String PATTERN_BREAKPOINT = "org.summer.sdt.debug.javaPatternBreakpointMarker"; //$NON-NLS-1$

	/**
	 * Breakpoint attribute storing the pattern identifier of the source file in
	 * which a breakpoint is created (value
	 * <code>"org.summer.sdt.debug.core.pattern"</code>). This attribute is a
	 * <code>String</code>.
	 */
	protected static final String PATTERN = "org.summer.sdt.debug.core.pattern"; //$NON-NLS-1$	
