...
import org.summer.sdt.internal.debug.ui.JDIDebugUIPreferenceInitializer;
import org.summer.sdt.internal.debug.ui.monitors.JavaElementContentProvider;
					...
					if (launch.getAttribute(ScrapbookLauncher.SCRAPBOOK_LAUNCH) != null) {
						if (event.getKind() == DebugEvent.SUSPEND) {
							try {
								...
								if (frame == null
										|| frame.getDeclaringTypeName().startsWith("org.summer.sdt.internal.debug.ui.snippeteditor.ScrapbookMain")) { //$NON-NLS-1$
									return false;
								}
							} catch (DebugException e) {
							}
