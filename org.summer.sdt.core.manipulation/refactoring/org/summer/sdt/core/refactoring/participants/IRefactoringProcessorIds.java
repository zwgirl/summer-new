 ...
 *******************************************************************************/
package org.summer.sdt.core.refactoring.participants;
...
public interface IRefactoringProcessorIds {
	 ...
	 * (value <code>"org.summer.sdt.ui.changeMethodSignatureRefactoring"</code>).
	 *
	 ...
	 */
	public static String CHANGE_METHOD_SIGNATURE_PROCESSOR= "org.summer.sdt.ui.changeMethodSignatureRefactoring"; //$NON-NLS-1$
	
	/**
	 * Processor ID of the Introduce Parameter Object processor
	 * (value <code>"org.summer.sdt.ui.introduceParameterObjectRefactoring"</code>).
	 *
	 * The Introduce Parameter Object processor loads {@link ChangeMethodSignatureParticipant}s registered for the
	 * <code>IMethod</code> whose signature is changed.
	 */
	public static String INTRODUCE_PARAMETER_OBJECT_PROCESSOR= "org.summer.sdt.ui.introduceParameterObjectRefactoring"; //$NON-NLS-1$
}
