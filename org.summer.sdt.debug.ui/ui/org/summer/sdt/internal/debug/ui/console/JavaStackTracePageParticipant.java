...
public class JavaStackTracePageParticipant implements IConsolePageParticipant {
	...
	public void activated() {
        ...
        fHandlerActivation = handlerService.activateHandler("org.summer.sdt.ui.edit.text.java.format", formatHandler); //$NON-NLS-1$
		
        IContextService contextService = (IContextService) workbench.getAdapter(IContextService.class);
        fContextActivation = contextService.activateContext("org.summer.sdt.ui.javaEditorScope"); //$NON-NLS-1$
	}
