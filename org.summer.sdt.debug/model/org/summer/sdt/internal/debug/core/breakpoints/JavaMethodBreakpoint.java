...
public class JavaMethodBreakpoint extends JavaLineBreakpoint implements
	...
	public static final String JAVA_METHOD_BREAKPOINT = "org.summer.sdt.debug.javaMethodBreakpointMarker"; //$NON-NLS-1$

	/**
	 * Breakpoint attribute storing the name of the method in which a breakpoint
	 * is contained. (value <code>"org.summer.sdt.debug.core.methodName"</code>
	 * ). This attribute is a <code>String</code>.
	 */
	protected static final String METHOD_NAME = "org.summer.sdt.debug.core.methodName"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing the signature of the method in which a
	 * breakpoint is contained. (value
	 * <code>"org.summer.sdt.debug.core.methodSignature"</code>). This
	 * attribute is a <code>String</code>.
	 */
	protected static final String METHOD_SIGNATURE = "org.summer.sdt.debug.core.methodSignature"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing whether this breakpoint is an entry
	 * breakpoint. (value <code>"org.summer.sdt.debug.core.entry"</code>). This
	 * attribute is a <code>boolean</code>.
	 */
	protected static final String ENTRY = "org.summer.sdt.debug.core.entry"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing whether this breakpoint is an exit
	 * breakpoint. (value <code>"org.summer.sdt.debug.core.exit"</code>). This
	 * attribute is a <code>boolean</code>.
	 */
	protected static final String EXIT = "org.summer.sdt.debug.core.exit"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing whether this breakpoint only applies to
	 * native methods. (value <code>"org.summer.sdt.debug.core.native"</code>).
	 * This attribute is a <code>boolean</code>.
	 */
	protected static final String NATIVE = "org.summer.sdt.debug.core.native"; //$NON-NLS-1$
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaMethodEntryBreakpoint#getMethodName()
	 */
	 ...
	 * 
	 * @see
	 * org.summer.sdt.debug.core.IJavaMethodEntryBreakpoint#getMethodSignature
	 * ()
	 */
	...
	/**
	 * @see org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#removeFromTarget(JDIDebugTarget)
	 */
	@Override
	 ...
	 * 
	 * @see org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#createRequest(JDIDebugTarget,
	 *      ReferenceType)
	 */
	@Override
	...
	/**
	 * @see org.summer.sdt.internal.debug.core.breakpoints.JavaBreakpoint#setTypeName(String)
	 */
	@Override
