...
import org.summer.jdi.internal.jdwp.JdwpPacket;
import org.summer.jdi.internal.jdwp.JdwpReplyPacket;
import org.summer.jdi.internal.jdwp.JdwpString;
...
public class MirrorImpl implements Mirror {
	...
	public MirrorImpl(String description) {
		...
		PrintWriter writer = ((VirtualMachineManagerImpl) org.summer.jdi.Bootstrap
	...
	public void defaultReplyErrorHandler(int error) {
		...
		case JdwpReplyPacket.HCR_OPERATION_REFUSED:
			throw new org.summer.jdi.hcr.OperationRefusedException();
