 ...
 * </p>
 * @since 2.0
 * @see org.summer.sdt.launching.IRuntimeClasspathEntry2
...
public interface IRuntimeClasspathEntry {
	 ...
	 * point <code>org.summer.sdt.launching.runtimeClasspathEntries</code>. The <code>memento</code> element will be used to initialize a restored
	...
	/**
	 * Returns the path associated with this entry, or <code>null</code> if none. The format of the path returned depends on this entry's type:
	 * <ul>
	 * <li><code>PROJECT</code> - a workspace relative path to the associated project.</li>
	 * <li><code>ARCHIVE</code> - the absolute path of the associated archive, which may or may not be in the workspace.</li>
	 * <li><code>VARIABLE</code> - the path corresponding to the associated classpath variable entry.</li>
	 * <li><code>CONTAINER</code> - the path corresponding to the associated classpath container variable entry.</li>
	 ...
	 * @see org.summer.sdt.core.IClasspathEntry#getPath()
	 */
