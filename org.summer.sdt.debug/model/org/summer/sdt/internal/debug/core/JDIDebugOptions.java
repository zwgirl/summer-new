 ...
 *******************************************************************************/
package org.summer.sdt.internal.debug.core;
...
public class JDIDebugOptions implements DebugOptionsListener {
	...
	public static final String DEBUG_AST_EVALUATIONS_CALLING_THREADS_FLAG = "org.summer.sdt.debug/debug/astEvaluations/callingThreads"; //$NON-NLS-1$
	public static final String DEBUG_AST_EVALUATIONS_FLAG = "org.summer.sdt.debug/debug/astEvaluations"; //$NON-NLS-1$
	public static final String DEBUG_JDI_REQUEST_TIMES_FLAG = "org.summer.sdt.debug/debug/jdiRequestTimes"; //$NON-NLS-1$
	public static final String DEBUG_JDI_EVENTS_FLAG = "org.summer.sdt.debug/debug/jdiEvents"; //$NON-NLS-1$
	public static final String DEBUG_FLAG = "org.summer.sdt.debug/debug"; //$NON-NLS-1$
