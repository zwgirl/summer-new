...
public interface IJavaDebugUIConstants {
	...
	/**
	 * Display view identifier (value <code>"org.summer.sdt.debug.ui.DisplayView"</code>).
	 */
	public static final String ID_DISPLAY_VIEW= PLUGIN_ID + ".DisplayView"; //$NON-NLS-1$
	
	/**
	 * Java snippet editor identifier (value <code>"org.summer.sdt.debug.ui.SnippetEditor"</code>)
	 */
