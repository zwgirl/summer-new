...
import org.summer.sdt.internal.debug.eval.ast.instructions.AndAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.AndOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.ArrayAllocation;
import org.summer.sdt.internal.debug.eval.ast.instructions.ArrayInitializerInstruction;
import org.summer.sdt.internal.debug.eval.ast.instructions.AssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.Cast;
import org.summer.sdt.internal.debug.eval.ast.instructions.CompoundInstruction;
import org.summer.sdt.internal.debug.eval.ast.instructions.ConditionalJump;
import org.summer.sdt.internal.debug.eval.ast.instructions.Constructor;
import org.summer.sdt.internal.debug.eval.ast.instructions.DivideAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.DivideOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.Dup;
import org.summer.sdt.internal.debug.eval.ast.instructions.DupX1;
import org.summer.sdt.internal.debug.eval.ast.instructions.EqualEqualOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.GreaterEqualOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.GreaterOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.InstanceOfOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.Instruction;
import org.summer.sdt.internal.debug.eval.ast.instructions.InstructionSequence;
import org.summer.sdt.internal.debug.eval.ast.instructions.Jump;
import org.summer.sdt.internal.debug.eval.ast.instructions.LeftShiftAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.LeftShiftOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.LessEqualOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.LessOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.LocalVariableCreation;
import org.summer.sdt.internal.debug.eval.ast.instructions.MinusAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.MinusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.MultiplyAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.MultiplyOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.NoOp;
import org.summer.sdt.internal.debug.eval.ast.instructions.NotOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.OrAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.OrOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.PlusAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.PlusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.Pop;
import org.summer.sdt.internal.debug.eval.ast.instructions.PostfixMinusMinusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.PostfixPlusPlusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.PrefixMinusMinusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.PrefixPlusPlusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushArrayLength;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushArrayType;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushBoolean;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushChar;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushClassLiteralValue;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushDouble;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushFieldVariable;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushFloat;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushInt;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushLocalVariable;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushLong;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushNull;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushPrimitiveType;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushStaticFieldVariable;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushString;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushThis;
import org.summer.sdt.internal.debug.eval.ast.instructions.PushType;
import org.summer.sdt.internal.debug.eval.ast.instructions.RemainderAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.RemainderOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.ReturnInstruction;
import org.summer.sdt.internal.debug.eval.ast.instructions.RightShiftAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.RightShiftOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.SendMessage;
import org.summer.sdt.internal.debug.eval.ast.instructions.SendStaticMessage;
import org.summer.sdt.internal.debug.eval.ast.instructions.ThrowInstruction;
import org.summer.sdt.internal.debug.eval.ast.instructions.TwiddleOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.UnaryMinusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.UnaryPlusOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.UnsignedRightShiftAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.UnsignedRightShiftOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.Value;
import org.summer.sdt.internal.debug.eval.ast.instructions.XorAssignmentOperator;
import org.summer.sdt.internal.debug.eval.ast.instructions.XorOperator;
...
public class ASTInstructionCompiler extends ASTVisitor {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#endVisit(org.summer.sdt.core.dom .EnhancedForStatement)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. AnnotationTypeDeclaration)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. AnnotationTypeMemberDeclaration)
	 */
	@Override
	...
	public boolean visit(ArrayAccess node) {
		...
		push(new org.summer.sdt.internal.debug.eval.ast.instructions.ArrayAccess(
				fCounter));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. BlockComment)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. EnhancedForStatement)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. EnumConstantDeclaration)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. EnumDeclaration)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. LineComment)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom.MemberRef )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. MemberValuePair)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom.MethodRef )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. MethodRefParameter)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom.Modifier )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. ParameterizedType)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. QualifiedType)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom.TagElement )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. TextElement)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. TypeParameter)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.summer.sdt.core.dom.ASTVisitor#visit(org.summer.sdt.core.dom. WildcardType)
	 */
	@Override
